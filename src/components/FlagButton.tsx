  ...
  return (
    <>
      <button
        ...
        title="Flag an issue"
        className="flex items-center gap-1.5 bg-white border border-red-300 rounded-full px-3 py-1 text-xs font-semibold text-[#EA3323] hover:bg-red-50 transition-colors flex-shrink-0"
      >
