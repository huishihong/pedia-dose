  ...
  return (
    <>
      <button
        ...
        title="Flag an issue"
        className="flex items-center gap-1.5 bg-red-50 border border-red-200 rounded-full px-3 py-1 text-xs font-semibold text-[#EA3323] hover:bg-red-100 hover:border-red-300 transition-colors flex-shrink-0"
      >
